...
\usepackage{xunicode}       % No idea
\usepackage{xstring}        % No idea
\usepackage{eso-pic,picture}% Still no idea
...
% Line spacing, and trading flush bottom for regular paragraph spacing
\linespread{1.2}
\raggedbottom
