...
% Subsection
%
\setsubsecheadstyle{\bfshape\scshape} % Subsection titles in small caps
...
%
\linespread{1.16} % Wider line spacing looks much better
...
%
\clubpenalty=80 % Last line of page new paragraph = not much of an issue
\widowpenalty=4000 % Avoids last line of paragraph on next page
\brokenpenalty=7000 % Avoids hyphenation across a page break
\doublehyphendemerits=90000 % Avoids hyphenation on consecutive lines
\hbadness=2000 % When compiling, only reports underfull lines if badness>2000
...
\XeTeXinterchartoks 0 \dashClass = \discretionary{}{}{\,}
\XeTeXinterchartoks \dashClass 255 = \discretionary{}{}{\,}
\XeTeXinterchartoks 255 \dashClass = \discretionary{}{}{\,}
...
\newenvironment{writtenNote}{%\parindent=1cm%
	...
	\par\noindent}
	{\end{em}\end{adjustwidth}\vskip 1\baselineskip plus 1\baselineskip minus 1\baselineskip}
