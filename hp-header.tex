...
\newcommand{\sbreak}{\par\vskip 1\baselineskip minus 1\baselineskip%
    {\begin{center}\Stars \end{center}}\vskip 1\baselineskip minus 1\baselineskip \par\noindent}
...
\makeatletter
\makeoddhead{headings}{\Stars}{\parbox{97mm}{\centering\hp\small\leftmark}}{\reflectbox{\Stars}}
