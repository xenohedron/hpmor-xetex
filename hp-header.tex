...
\newfontface\hpchap[ExternalLocation, LetterSpace=72.0, WordSpace=2.0]{Lumos}
%
...
%
\newcommand{\sbreak}{\par\vskip .5\baselineskip minus .5\baselineskip%
    {\begin{center}\Stars \end{center}}\vskip .5\baselineskip minus .5\baselineskip \par\noindent}
...
\makeevenhead{headings}{\Stars}{
	\hp\hyperref[contents]{\scriptsize\rightmark}}{\reflectbox{\Stars}}
\makeatletter
\makeoddhead{headings}{\Stars}{\parbox{99mm}{\centering\hp\scriptsize\leftmark}}{\reflectbox{\Stars}}
...
\newcommand*{\prophecy}[1]{\textbf{\textit{\textsc{#1}}}} % Prophecies are set in italic small caps
\newcommand*{\headline}[1]{\textsc{#1}} % Newspaper headlines
