...
\settypeblocksize{\topskip  + 32\baselineskip}{4.3in}{*}
\setlrmargins{*}{*}{1}
\setulmargins{*}{*}{1}
...
\newfontface\hp[ExternalLocation, LetterSpace=18.0]{Lumos}
\newcommand{\lumos}[1]{{\hp\MakeUppercase{#1}}}
\newfontface\hpchap[ExternalLocation, LetterSpace=72.0]{Lumos}
...
\makechapterstyle{evans}{%
	...
	\renewcommand*{\printchapternum}{%
		\centering \chapnumfont $\qquad$\hyperref[contents]{CHAPTER$\qquad$\NUMTONAME{\thechapter}
