...
\settypeblocksize{\topskip  + 32\baselineskip}{4.4in}{*}
\setlrmargins{*}{*}{1}
\setulmargins{*}{*}{1}
...
\newfontface\hp[ExternalLocation, LetterSpace=8.0]{Lumos}
...
\makechapterstyle{evans}{%
	...
	\renewcommand*{\printchapternum}{%
		\centering \chapnumfont $\qquad$\hyperref[contents]{CHAPTER$\qquad$ 
